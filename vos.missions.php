...
<?php 
  include_once('includes/header.php'); 
          ...
          $req = $bdd->prepare('SELECT * FROM annonces WHERE id_soci = :id_soci');
          $req->execute(array(
          'id_soci' => $_SESSION['id']
          ));
          $a = 0;
...
<div class="container mise-en-page">
    <div style="background-color: #337ab7;color: white;">
      <span>
        <center><h1>Vos MISSIONS EN LIGNE</h1></center>
      </span>
    </div>
    ...
    <div class="hr-bleu">
      <span>
        <h3>&nbsp;Nombre de MISSIONS en ligne: <?php echo $a ?> MISSION(S)</h3>
      </span>
    </div> 
